...
describe('useSceneStore', () => {
  ...
  // ============================================================================
// AGREGA ESTOS TESTS AL FINAL DE src/stores/scene/__tests__/useSceneStore.test.ts
// ANTES DEL ÚLTIMO }); DEL ARCHIVO
// ============================================================================

  // --------------------------------------------------------------------------
  // NUEVOS TESTS - updateFloorTexture Advanced
  // --------------------------------------------------------------------------
  ...
  // --------------------------------------------------------------------------
  // NUEVOS TESTS - updateItemFenceConfig Advanced
  // --------------------------------------------------------------------------
  ...
  // --------------------------------------------------------------------------
  // NUEVOS TESTS - undo/redo with totalPrice recalculation
  // --------------------------------------------------------------------------
...
// ============================================================================
// FIN DE TESTS ADICIONALES PARA useSceneStore.test.ts
// ============================================================================
});
