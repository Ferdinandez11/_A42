 ...
 */
export interface ProductDefinition extends ProductBase {
  // Required fields
...
// Producto del catálogo (ahora TIENE modelUrl)
export interface CatalogProduct extends ProductDefinition {
  ...
  // ... cualquier otra propiedad específica del catálogo
}

// Producto colocable en escena (también TIENE modelUrl)
export interface PlaceableProduct extends ProductDefinition {
  position?: { x: number; y: number; z: number }
  rotation?: { x: number; y: number; z: number }
  scale?: { x: number; y: number; z: number }
  // ... propiedades específicas del placement
}
